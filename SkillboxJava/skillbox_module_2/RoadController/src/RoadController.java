...
public class RoadController
{
    ...
    private static int calculatePrice(Car car)
    {
        ...
        {
            double weight = car.getWeight(); // Переменная типа double
            //Грузовой автомобиль
            if (weight > passengerCarMaxWeight)
            {
                price = cargoCarPrice; // Исправлено: не правильные присвоения цен.
            ...
            //Легковой автомобиль
                ...
                price = passengerCarPrice; // Исправлено: не правильные присвоения цен.
            }
        }
        else {
